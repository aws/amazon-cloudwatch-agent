...
func (config *Files) AddLogFile(filePath, logGroupName, logStreamName, kmsKeyID string, timestampFormat, timezone, multiLineStartPattern, encoding string, retention int, logGroupClass string) {
