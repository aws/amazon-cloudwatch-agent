...
config-translator: create-version-file
...
start-amazon-cloudwatch-agent: create-version-file
...
amazon-cloudwatch-agent-config-wizard: create-version-file
...
config-downloader: create-version-file
