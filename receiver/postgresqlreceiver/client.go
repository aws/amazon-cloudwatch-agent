...
import (
	...
	"github.com/aws/amazon-cloudwatch-agent/receiver/postgresqlreceiver/internal/sqlquery"
)
...
type client interface {
	...
	getSessionStates(ctx context.Context) (map[string]int64, error) // CWA gap fix
}
...
// CWA gap fix: session state metric
