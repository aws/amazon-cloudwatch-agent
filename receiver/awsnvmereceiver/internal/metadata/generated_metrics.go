...
func (m *metricDiskioEbsTotalReadBytes) init() {
	...
	m.data.SetDescription("The total number of read bytes transferred for EBS devices")
	m.data.SetUnit("By")
	m.data.SetEmptySum()
	m.data.Sum().SetIsMonotonic(true)
	m.data.Sum().SetAggregationTemporality(pmetric.AggregationTemporalityCumulative)
...
func (m *metricDiskioEbsTotalReadOps) init() {
	...
	m.data.SetDescription("The total number of completed read operations for EBS devices")
	m.data.SetUnit("1")
	m.data.SetEmptySum()
	m.data.Sum().SetIsMonotonic(true)
	m.data.Sum().SetAggregationTemporality(pmetric.AggregationTemporalityCumulative)
...
func (m *metricDiskioEbsTotalReadTime) init() {
	...
	m.data.SetDescription("The total time spent, in nanoseconds, by all completed read operations for EBS devices")
	m.data.SetUnit("ns")
	m.data.SetEmptySum()
	m.data.Sum().SetIsMonotonic(true)
	m.data.Sum().SetAggregationTemporality(pmetric.AggregationTemporalityCumulative)
...
func (m *metricDiskioEbsTotalWriteBytes) init() {
	...
	m.data.SetDescription("The total number of write bytes transferred for EBS devices")
	m.data.SetUnit("By")
	m.data.SetEmptySum()
	m.data.Sum().SetIsMonotonic(true)
	m.data.Sum().SetAggregationTemporality(pmetric.AggregationTemporalityCumulative)
...
func (m *metricDiskioEbsTotalWriteOps) init() {
	...
	m.data.SetDescription("The total number of completed write operations for EBS devices")
	m.data.SetUnit("1")
	m.data.SetEmptySum()
	m.data.Sum().SetIsMonotonic(true)
	m.data.Sum().SetAggregationTemporality(pmetric.AggregationTemporalityCumulative)
...
func (m *metricDiskioEbsTotalWriteTime) init() {
	...
	m.data.SetDescription("The total time spent, in nanoseconds, by all completed write operations for EBS devices")
	m.data.SetUnit("ns")
	m.data.SetEmptySum()
	m.data.Sum().SetIsMonotonic(true)
	m.data.Sum().SetAggregationTemporality(pmetric.AggregationTemporalityCumulative)
...
func (m *metricDiskioEbsVolumePerformanceExceededIops) init() {
	...
	m.data.SetDescription("The total time, in nanoseconds, that IOPS demand exceeded the EBS volume's provisioned IOPS performance")
	m.data.SetUnit("ns")
	m.data.SetEmptySum()
	m.data.Sum().SetIsMonotonic(true)
	m.data.Sum().SetAggregationTemporality(pmetric.AggregationTemporalityCumulative)
...
func (m *metricDiskioEbsVolumePerformanceExceededTp) init() {
	...
	m.data.SetDescription("The total time, in nanoseconds, that throughput demand exceeded the EBS volume's provisioned throughput performance")
	m.data.SetUnit("ns")
	m.data.SetEmptySum()
	m.data.Sum().SetIsMonotonic(true)
	m.data.Sum().SetAggregationTemporality(pmetric.AggregationTemporalityCumulative)
...
func (m *metricDiskioEbsVolumeQueueLength) init() {
	...
	m.data.SetDescription("The number of read and write operations waiting to be completed for EBS devices")
	m.data.SetUnit("1")
...
func NewMetricsBuilder(mbc MetricsBuilderConfig, settings receiver.Settings, options ...MetricBuilderOption) *MetricsBuilder {
	...
	if mbc.ResourceAttributes.DeviceType.MetricsInclude != nil {
		mb.resourceAttributeIncludeFilter["device_type"] = filter.CreateFilter(mbc.ResourceAttributes.DeviceType.MetricsInclude)
	}
	if mbc.ResourceAttributes.DeviceType.MetricsExclude != nil {
		mb.resourceAttributeExcludeFilter["device_type"] = filter.CreateFilter(mbc.ResourceAttributes.DeviceType.MetricsExclude)
	}
	if mbc.ResourceAttributes.InstanceID.MetricsInclude != nil {
		mb.resourceAttributeIncludeFilter["instance_id"] = filter.CreateFilter(mbc.ResourceAttributes.InstanceID.MetricsInclude)
	}
	if mbc.ResourceAttributes.InstanceID.MetricsExclude != nil {
		mb.resourceAttributeExcludeFilter["instance_id"] = filter.CreateFilter(mbc.ResourceAttributes.InstanceID.MetricsExclude)
	}
	if mbc.ResourceAttributes.SerialNumber.MetricsInclude != nil {
		mb.resourceAttributeIncludeFilter["serial_number"] = filter.CreateFilter(mbc.ResourceAttributes.SerialNumber.MetricsInclude)
	}
	if mbc.ResourceAttributes.SerialNumber.MetricsExclude != nil {
		mb.resourceAttributeExcludeFilter["serial_number"] = filter.CreateFilter(mbc.ResourceAttributes.SerialNumber.MetricsExclude)
	}
