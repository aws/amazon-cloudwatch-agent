...
sed -i '' "s|github\.com/amazon-contributing/opentelemetry-collector-contrib/\([^@]*\) v0\.0\.0-[0-9]*-[a-f0-9]*|github.com/amazon-contributing/opentelemetry-collector-contrib/\1 v0.0.0-$TIMESTAMP-$LATEST_SHA|g" go.mod
