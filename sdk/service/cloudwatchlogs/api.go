...
func (s *PutLogEventsInput) SetEntity(v *Entity) *PutLogEventsInput {
	s.Entity = v
	return s
}
...
// SetRejectedEntityInfo sets the RejectedEntityInfo field's value.
func (s *PutLogEventsOutput) SetRejectedEntityInfo(v *RejectedEntityInfo) *PutLogEventsOutput {
	s.RejectedEntityInfo = v
	return s
}
...
// be included in the string output. The member name will be present, but the
// value will be replaced with "sensitive".
func (s RejectedEntityInfo) String() string {
	return awsutil.Prettify(s)
}
...
// be included in the string output. The member name will be present, but the
// value will be replaced with "sensitive".
func (s RejectedEntityInfo) GoString() string {
	return s.String()
}

// SetErrorType sets the ErrorType field's value.
func (s *RejectedEntityInfo) SetErrorType(v string) *RejectedEntityInfo {
	s.ErrorType = &v
	return s
}
...
const (
	// EntityRejectionErrorTypeInvalidEntity is a EntityRejectionErrorType enum value
	EntityRejectionErrorTypeInvalidEntity = "InvalidEntity"

	// EntityRejectionErrorTypeInvalidTypeValue is a EntityRejectionErrorType enum value
	EntityRejectionErrorTypeInvalidTypeValue = "InvalidTypeValue"

	// EntityRejectionErrorTypeInvalidKeyAttributes is a EntityRejectionErrorType enum value
	EntityRejectionErrorTypeInvalidKeyAttributes = "InvalidKeyAttributes"

	// EntityRejectionErrorTypeInvalidAttributes is a EntityRejectionErrorType enum value
	EntityRejectionErrorTypeInvalidAttributes = "InvalidAttributes"

	// EntityRejectionErrorTypeEntitySizeTooLarge is a EntityRejectionErrorType enum value
	EntityRejectionErrorTypeEntitySizeTooLarge = "EntitySizeTooLarge"

	// EntityRejectionErrorTypeUnsupportedLogGroupType is a EntityRejectionErrorType enum value
	EntityRejectionErrorTypeUnsupportedLogGroupType = "UnsupportedLogGroupType"

	// EntityRejectionErrorTypeMissingRequiredFields is a EntityRejectionErrorType enum value
	EntityRejectionErrorTypeMissingRequiredFields = "MissingRequiredFields"
)

// EntityRejectionErrorType_Values returns all elements of the EntityRejectionErrorType enum
func EntityRejectionErrorType_Values() []string {
	return []string{
		EntityRejectionErrorTypeInvalidEntity,
		EntityRejectionErrorTypeInvalidTypeValue,
		EntityRejectionErrorTypeInvalidKeyAttributes,
		EntityRejectionErrorTypeInvalidAttributes,
		EntityRejectionErrorTypeEntitySizeTooLarge,
		EntityRejectionErrorTypeUnsupportedLogGroupType,
		EntityRejectionErrorTypeMissingRequiredFields,
	}
}
