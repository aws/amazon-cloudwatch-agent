...
func TestRetryHeapProcessorExpiredBatch(t *testing.T) {
	...
	batch.updateRetryMetadata(&types.ServiceUnavailableException{})
...
func TestRetryHeapProcessorSendsBatch(t *testing.T) {
	...
	mockService.AssertCalled(t, "PutLogEvents", mock.Anything, mock.Anything, mock.Anything)
}
...
func TestRetryHeapProcessorFailedBatchGoesBackToHeap(t *testing.T) {
	...
	mockService := &mockLogsService{}
	mockService.On("PutLogEvents", mock.Anything, mock.Anything, mock.Anything).Return(&cloudwatchlogs.PutLogEventsOutput{}, &types.ServiceUnavailableException{})
	...
	batch.events = append(batch.events, types.InputLogEvent{
		Message:   &message,
		Timestamp: &timestamp,
	})
...
func TestRetryHeapProcessorStopDoesNotDeadlock(t *testing.T) {
	...
	service := okStubService(func(context.Context, *cloudwatchlogs.PutLogEventsInput) (*cloudwatchlogs.PutLogEventsOutput, error) {
		inFlight.Add(1)
		<-release
...
func TestRetryHeapProcessorStopDoesNotBlockOnSaturatedPool(t *testing.T) {
	logger := &testutil.Logger{}
	svc := okStubService(func(context.Context, *cloudwatchlogs.PutLogEventsInput) (*cloudwatchlogs.PutLogEventsOutput, error) {
		return &cloudwatchlogs.PutLogEventsOutput{}, nil
	})
...
func TestRetryHeapSuccessCallsStateCallback(t *testing.T) {
	...
	service := &stubLogsService{
		ple: func(_ context.Context, _ *cloudwatchlogs.PutLogEventsInput) (*cloudwatchlogs.PutLogEventsOutput, error) {
			return &cloudwatchlogs.PutLogEventsOutput{}, nil
		},
		cls: func(_ context.Context, _ *cloudwatchlogs.CreateLogStreamInput) (*cloudwatchlogs.CreateLogStreamOutput, error) {
			return &cloudwatchlogs.CreateLogStreamOutput{}, nil
		},
		clg: func(_ context.Context, _ *cloudwatchlogs.CreateLogGroupInput) (*cloudwatchlogs.CreateLogGroupOutput, error) {
			return &cloudwatchlogs.CreateLogGroupOutput{}, nil
		},
		dlg: func(_ context.Context, _ *cloudwatchlogs.DescribeLogGroupsInput) (*cloudwatchlogs.DescribeLogGroupsOutput, error) {
