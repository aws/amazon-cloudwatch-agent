...
var metricNameToMetricLayout = map[string]MetricDefinition{
	...
	NeuronCoreMemoryUsageModelSharedScratchpad: {MetricType: pmetric.MetricTypeGauge, MetricValues: []float64{1, 2, 3}, SpecialAttributes: [][]string{{NeuronCore, "0", NeuronDevice, "0", NeuronCoreTag, "0", MemoryLocation, "None", PodName, DummyPod}, {NeuronCore, "1", NeuronDevice, "0", NeuronCoreTag, "1", MemoryLocation, "None", PodName, DummyPod}, {NeuronCore, "2", NeuronDevice, "1", NeuronCoreTag, "2", MemoryLocation, "None", PodName, DummyPod}}, Unit: Bytes},
	...
	NeuronCoreUtilizationRatio:                 {MetricType: pmetric.MetricTypeGauge, MetricValues: []float64{1, 2, 3, 4, 5, 6}, SpecialAttributes: [][]string{{NeuronCore, "0", NeuronDevice, "0", NeuronCoreTag, "0", MemoryLocation, "None", PodName, DummyPod, RuntimeTag, "DEFAULT"}, {NeuronCore, "1", NeuronDevice, "0", NeuronCoreTag, "1", MemoryLocation, "None", PodName, DummyPod, RuntimeTag, "123"}, {NeuronCore, "2", NeuronDevice, "1", NeuronCoreTag, "2", MemoryLocation, "None", PodName, DummyPod, RuntimeTag, "123"}, {NeuronCore, "0", NeuronDevice, "0", NeuronCoreTag, "0", MemoryLocation, "None", PodName, DummyPod, RuntimeTag, "456"}, {NeuronCore, "1", NeuronDevice, "0", NeuronCoreTag, "1", MemoryLocation, "None", PodName, DummyPod, RuntimeTag, "456"}, {NeuronCore, "2", NeuronDevice, "1", NeuronCoreTag, "2", MemoryLocation, "None", PodName, DummyPod, RuntimeTag, "456"}}, Unit: Percent},
}
...
func TestMetricModifierForExecutionErrorMetric(t *testing.T) {
	...
	expectedMetrics := map[string]pmetric.Metric{
		...
		"node_neuron_execution_errors_generic":   createExpectedMetric("node_neuron_execution_errors_generic", true, []map[string]string{{Type: NodeAWSNeuron, RuntimeTag: RuntimeTagOverride, ErrorType: "generic"}}, []float64{1}, pmetric.MetricTypeSum, Count),
		"node_neuron_execution_errors_numerical": createExpectedMetric("node_neuron_execution_errors_numerical", true, []map[string]string{{Type: NodeAWSNeuron, RuntimeTag: RuntimeTagOverride, ErrorType: "numerical"}}, []float64{2}, pmetric.MetricTypeSum, Count),
		"node_neuron_execution_errors_transient": createExpectedMetric("node_neuron_execution_errors_transient", true, []map[string]string{{Type: NodeAWSNeuron, RuntimeTag: RuntimeTagOverride, ErrorType: "transient"}}, []float64{3}, pmetric.MetricTypeSum, Count),
		"node_neuron_execution_errors_model":     createExpectedMetric("node_neuron_execution_errors_model", true, []map[string]string{{Type: NodeAWSNeuron, RuntimeTag: RuntimeTagOverride, ErrorType: "model"}}, []float64{4}, pmetric.MetricTypeSum, Count),
		"node_neuron_execution_errors_runtime":   createExpectedMetric("node_neuron_execution_errors_runtime", true, []map[string]string{{Type: NodeAWSNeuron, RuntimeTag: RuntimeTagOverride, ErrorType: "runtime"}}, []float64{5}, pmetric.MetricTypeSum, Count),
		"node_neuron_execution_errors_hardware":  createExpectedMetric("node_neuron_execution_errors_hardware", true, []map[string]string{{Type: NodeAWSNeuron, RuntimeTag: RuntimeTagOverride, ErrorType: "hardware"}}, []float64{6}, pmetric.MetricTypeSum, Count),
		"node_neuron_execution_errors_total":     createExpectedMetric("node_neuron_execution_errors_total", true, []map[string]string{{Type: NodeAWSNeuron, RuntimeTag: RuntimeTagOverride, ErrorType: "generic"}}, []float64{21}, pmetric.MetricTypeSum, Count),
	}
...
func TestMetricModifierForExecutionStatusMetric(t *testing.T) {
	...
	expectedMetrics := map[string]pmetric.Metric{
		...
		"node_neuron_execution_status_completed":              createExpectedMetric("node_neuron_execution_status_completed", true, []map[string]string{{Type: NodeAWSNeuron, RuntimeTag: RuntimeTagOverride, StatusType: "completed"}}, []float64{1}, pmetric.MetricTypeSum, Count),
		"node_neuron_execution_status_completed_with_err":     createExpectedMetric("node_neuron_execution_status_completed_with_err", true, []map[string]string{{Type: NodeAWSNeuron, RuntimeTag: RuntimeTagOverride, StatusType: "completed_with_err"}}, []float64{2}, pmetric.MetricTypeSum, Count),
		"node_neuron_execution_status_completed_with_num_err": createExpectedMetric("node_neuron_execution_status_completed_with_num_err", true, []map[string]string{{Type: NodeAWSNeuron, RuntimeTag: RuntimeTagOverride, StatusType: "completed_with_num_err"}}, []float64{3}, pmetric.MetricTypeSum, Count),
		"node_neuron_execution_status_timed_out":              createExpectedMetric("node_neuron_execution_status_timed_out", true, []map[string]string{{Type: NodeAWSNeuron, RuntimeTag: RuntimeTagOverride, StatusType: "timed_out"}}, []float64{4}, pmetric.MetricTypeSum, Count),
...
func TestMetricModifierForNeuronCoreMemoryUsageMetric(t *testing.T) {
	...
	expectedMetrics := map[string]pmetric.Metric{
		...
		"node_neuroncore_memory_usage_model_shared_scratchpad":      createExpectedMetric("node_neuroncore_memory_usage_model_shared_scratchpad", false, []map[string]string{{NeuronCore: "core0", NeuronDevice: "device0", NeuronCoreTag: "0", Type: NodeAWSNeuronCore, PodName: DummyPod, MemoryLocation: "None"}, {NeuronCore: "core1", NeuronDevice: "device0", NeuronCoreTag: "1", Type: NodeAWSNeuronCore, PodName: DummyPod, MemoryLocation: "None"}, {NeuronCore: "core2", NeuronDevice: "device1", NeuronCoreTag: "2", Type: NodeAWSNeuronCore, PodName: DummyPod, MemoryLocation: "None"}}, []float64{1, 2, 3}, pmetric.MetricTypeSum, Bytes),
		"pod_neuroncore_memory_usage_model_shared_scratchpad":       createExpectedMetric("pod_neuroncore_memory_usage_model_shared_scratchpad", false, []map[string]string{{NeuronCore: "core0", NeuronDevice: "device0", NeuronCoreTag: "0", Type: PodAWSNeuronCore, PodName: DummyPod, MemoryLocation: "None"}, {NeuronCore: "core1", NeuronDevice: "device0", NeuronCoreTag: "1", Type: PodAWSNeuronCore, PodName: DummyPod, MemoryLocation: "None"}, {NeuronCore: "core2", NeuronDevice: "device1", NeuronCoreTag: "2", Type: PodAWSNeuronCore, PodName: DummyPod, MemoryLocation: "None"}}, []float64{1, 2, 3}, pmetric.MetricTypeSum, Bytes),
		"container_neuroncore_memory_usage_model_shared_scratchpad": createExpectedMetric("container_neuroncore_memory_usage_model_shared_scratchpad", false, []map[string]string{{NeuronCore: "core0", NeuronDevice: "device0", NeuronCoreTag: "0", Type: ContainerAWSNeuronCore, PodName: DummyPod, MemoryLocation: "None"}, {NeuronCore: "core1", NeuronDevice: "device0", NeuronCoreTag: "1", Type: ContainerAWSNeuronCore, PodName: DummyPod, MemoryLocation: "None"}, {NeuronCore: "core2", NeuronDevice: "device1", NeuronCoreTag: "2", Type: ContainerAWSNeuronCore, PodName: DummyPod, MemoryLocation: "None"}}, []float64{1, 2, 3}, pmetric.MetricTypeSum, Bytes),
	}
...
func TestMetricModifierForNeuronCoreMemoryUsageMetric_PodNameMissing(t *testing.T) {
	...
	expectedMetrics := map[string]pmetric.Metric{
		NeuronCoreMemoryUsageModelSharedScratchpad:             metricsList.At(0),
		"node_neuroncore_memory_usage_model_shared_scratchpad": createExpectedMetric("node_neuroncore_memory_usage_model_shared_scratchpad", false, []map[string]string{{NeuronCore: "core0", NeuronDevice: "device0", NeuronCoreTag: "0", Type: NodeAWSNeuronCore, MemoryLocation: "None"}, {NeuronCore: "core1", NeuronDevice: "device0", NeuronCoreTag: "1", Type: NodeAWSNeuronCore, MemoryLocation: "None"}, {NeuronCore: "core2", NeuronDevice: "device1", NeuronCoreTag: "2", Type: NodeAWSNeuronCore, MemoryLocation: "None"}}, []float64{1, 2, 3}, pmetric.MetricTypeSum, Bytes),
	}
...
func TestMetricModifierForNeuronDeviceEccEventMetric(t *testing.T) {
	...
	expectedMetrics := map[string]pmetric.Metric{
		...
		"node_neurondevice_hw_ecc_events_mem_ecc_corrected":         createExpectedMetric("node_neurondevice_hw_ecc_events_mem_ecc_corrected", false, []map[string]string{{NeuronDeviceIndex: "1", NeuronDevice: "device1", PodName: DummyPod, Type: NodeAWSNeuronDevice, RuntimeTag: RuntimeTagOverride, EventType: "mem_ecc_corrected"}}, []float64{1}, pmetric.MetricTypeSum, Count),
		"node_neurondevice_hw_ecc_events_mem_ecc_uncorrected":       createExpectedMetric("node_neurondevice_hw_ecc_events_mem_ecc_uncorrected", false, []map[string]string{{NeuronDeviceIndex: "1", NeuronDevice: "device1", PodName: DummyPod, Type: NodeAWSNeuronDevice, RuntimeTag: RuntimeTagOverride, EventType: "mem_ecc_uncorrected"}}, []float64{2}, pmetric.MetricTypeSum, Count),
		"node_neurondevice_hw_ecc_events_sram_ecc_corrected":        createExpectedMetric("node_neurondevice_hw_ecc_events_sram_ecc_corrected", false, []map[string]string{{NeuronDeviceIndex: "1", NeuronDevice: "device1", PodName: DummyPod, Type: NodeAWSNeuronDevice, RuntimeTag: RuntimeTagOverride, EventType: "sram_ecc_corrected"}}, []float64{3}, pmetric.MetricTypeSum, Count),
		"node_neurondevice_hw_ecc_events_sram_ecc_uncorrected":      createExpectedMetric("node_neurondevice_hw_ecc_events_sram_ecc_uncorrected", false, []map[string]string{{NeuronDeviceIndex: "1", NeuronDevice: "device1", PodName: DummyPod, Type: NodeAWSNeuronDevice, RuntimeTag: RuntimeTagOverride, EventType: "sram_ecc_uncorrected"}}, []float64{4}, pmetric.MetricTypeSum, Count),
		"node_neurondevice_hw_ecc_events_total":                     createExpectedMetric("node_neurondevice_hw_ecc_events_total", false, []map[string]string{{NeuronDeviceIndex: "1", NeuronDevice: "device1", PodName: DummyPod, Type: NodeAWSNeuronDevice, RuntimeTag: RuntimeTagOverride, EventType: "mem_ecc_corrected"}}, []float64{10}, pmetric.MetricTypeSum, Count),
		"pod_neurondevice_hw_ecc_events_mem_ecc_corrected":          createExpectedMetric("pod_neurondevice_hw_ecc_events_mem_ecc_corrected", false, []map[string]string{{NeuronDeviceIndex: "1", NeuronDevice: "device1", PodName: DummyPod, Type: PodAWSNeuronDevice, RuntimeTag: RuntimeTagOverride, EventType: "mem_ecc_corrected"}}, []float64{1}, pmetric.MetricTypeSum, Count),
		"pod_neurondevice_hw_ecc_events_mem_ecc_uncorrected":        createExpectedMetric("pod_neurondevice_hw_ecc_events_mem_ecc_uncorrected", false, []map[string]string{{NeuronDeviceIndex: "1", NeuronDevice: "device1", PodName: DummyPod, Type: PodAWSNeuronDevice, RuntimeTag: RuntimeTagOverride, EventType: "mem_ecc_uncorrected"}}, []float64{2}, pmetric.MetricTypeSum, Count),
		"pod_neurondevice_hw_ecc_events_sram_ecc_corrected":         createExpectedMetric("pod_neurondevice_hw_ecc_events_sram_ecc_corrected", false, []map[string]string{{NeuronDeviceIndex: "1", NeuronDevice: "device1", PodName: DummyPod, Type: PodAWSNeuronDevice, RuntimeTag: RuntimeTagOverride, EventType: "sram_ecc_corrected"}}, []float64{3}, pmetric.MetricTypeSum, Count),
		"pod_neurondevice_hw_ecc_events_sram_ecc_uncorrected":       createExpectedMetric("pod_neurondevice_hw_ecc_events_sram_ecc_uncorrected", false, []map[string]string{{NeuronDeviceIndex: "1", NeuronDevice: "device1", PodName: DummyPod, Type: PodAWSNeuronDevice, RuntimeTag: RuntimeTagOverride, EventType: "sram_ecc_uncorrected"}}, []float64{4}, pmetric.MetricTypeSum, Count),
		"pod_neurondevice_hw_ecc_events_total":                      createExpectedMetric("pod_neurondevice_hw_ecc_events_total", false, []map[string]string{{NeuronDeviceIndex: "1", NeuronDevice: "device1", PodName: DummyPod, Type: PodAWSNeuronDevice, RuntimeTag: RuntimeTagOverride, EventType: "mem_ecc_corrected"}}, []float64{10}, pmetric.MetricTypeSum, Count),
		"container_neurondevice_hw_ecc_events_mem_ecc_corrected":    createExpectedMetric("container_neurondevice_hw_ecc_events_mem_ecc_corrected", false, []map[string]string{{NeuronDeviceIndex: "1", NeuronDevice: "device1", PodName: DummyPod, Type: ContainerAWSNeuronDevice, RuntimeTag: RuntimeTagOverride, EventType: "mem_ecc_corrected"}}, []float64{1}, pmetric.MetricTypeSum, Count),
		"container_neurondevice_hw_ecc_events_mem_ecc_uncorrected":  createExpectedMetric("container_neurondevice_hw_ecc_events_mem_ecc_uncorrected", false, []map[string]string{{NeuronDeviceIndex: "1", NeuronDevice: "device1", PodName: DummyPod, Type: ContainerAWSNeuronDevice, RuntimeTag: RuntimeTagOverride, EventType: "mem_ecc_uncorrected"}}, []float64{2}, pmetric.MetricTypeSum, Count),
		"container_neurondevice_hw_ecc_events_sram_ecc_corrected":   createExpectedMetric("container_neurondevice_hw_ecc_events_sram_ecc_corrected", false, []map[string]string{{NeuronDeviceIndex: "1", NeuronDevice: "device1", PodName: DummyPod, Type: ContainerAWSNeuronDevice, RuntimeTag: RuntimeTagOverride, EventType: "sram_ecc_corrected"}}, []float64{3}, pmetric.MetricTypeSum, Count),
		"container_neurondevice_hw_ecc_events_sram_ecc_uncorrected": createExpectedMetric("container_neurondevice_hw_ecc_events_sram_ecc_uncorrected", false, []map[string]string{{NeuronDeviceIndex: "1", NeuronDevice: "device1", PodName: DummyPod, Type: ContainerAWSNeuronDevice, RuntimeTag: RuntimeTagOverride, EventType: "sram_ecc_uncorrected"}}, []float64{4}, pmetric.MetricTypeSum, Count),
		"container_neurondevice_hw_ecc_events_total":                createExpectedMetric("container_neurondevice_hw_ecc_events_total", false, []map[string]string{{NeuronDeviceIndex: "1", NeuronDevice: "device1", PodName: DummyPod, Type: ContainerAWSNeuronDevice, RuntimeTag: RuntimeTagOverride, EventType: "mem_ecc_corrected"}}, []float64{10}, pmetric.MetricTypeSum, Count),
	}
...
func TestMetricModifierForNeuronDeviceEccEventMetric_PodNameMissing(t *testing.T) {
	...
	expectedMetrics := map[string]pmetric.Metric{
		...
		"node_neurondevice_hw_ecc_events_sram_ecc_corrected":   createExpectedMetric("node_neurondevice_hw_ecc_events_sram_ecc_corrected", false, []map[string]string{{NeuronDeviceIndex: "1", NeuronDevice: "device1", Type: NodeAWSNeuronDevice, RuntimeTag: RuntimeTagOverride, EventType: "sram_ecc_corrected"}}, []float64{3}, pmetric.MetricTypeSum, Count),
		"node_neurondevice_hw_ecc_events_sram_ecc_uncorrected": createExpectedMetric("node_neurondevice_hw_ecc_events_sram_ecc_uncorrected", false, []map[string]string{{NeuronDeviceIndex: "1", NeuronDevice: "device1", Type: NodeAWSNeuronDevice, RuntimeTag: RuntimeTagOverride, EventType: "sram_ecc_uncorrected"}}, []float64{4}, pmetric.MetricTypeSum, Count),
		"node_neurondevice_hw_ecc_events_total":                createExpectedMetric("node_neurondevice_hw_ecc_events_total", false, []map[string]string{{NeuronDeviceIndex: "1", NeuronDevice: "device1", Type: NodeAWSNeuronDevice, RuntimeTag: RuntimeTagOverride, EventType: "mem_ecc_corrected"}}, []float64{10}, pmetric.MetricTypeSum, Count),
	}
...
func TestMetricModifierForNeuronCoreUtilizationUsageMetric(t *testing.T) {
	...
	expectedMetrics := map[string]pmetric.Metric{
		...
		"node_neuroncore_utilization":      createExpectedMetric("node_neuroncore_utilization", false, []map[string]string{{NeuronCore: "core0", NeuronDevice: "device0", NeuronCoreTag: "0", Type: NodeAWSNeuronCore, PodName: DummyPod, MemoryLocation: "None", RuntimeTag: "DEFAULT"}, {NeuronCore: "core1", NeuronDevice: "device0", NeuronCoreTag: "1", Type: NodeAWSNeuronCore, PodName: DummyPod, MemoryLocation: "None", RuntimeTag: "DEFAULT"}, {NeuronCore: "core2", NeuronDevice: "device1", NeuronCoreTag: "2", Type: NodeAWSNeuronCore, PodName: DummyPod, MemoryLocation: "None", RuntimeTag: "DEFAULT"}}, []float64{4, 5, 6}, pmetric.MetricTypeSum, Percent),
		"pod_neuroncore_utilization":       createExpectedMetric("pod_neuroncore_utilization", false, []map[string]string{{NeuronCore: "core0", NeuronDevice: "device0", NeuronCoreTag: "0", Type: PodAWSNeuronCore, PodName: DummyPod, MemoryLocation: "None", RuntimeTag: "DEFAULT"}, {NeuronCore: "core1", NeuronDevice: "device0", NeuronCoreTag: "1", Type: PodAWSNeuronCore, PodName: DummyPod, MemoryLocation: "None", RuntimeTag: "DEFAULT"}, {NeuronCore: "core2", NeuronDevice: "device1", NeuronCoreTag: "2", Type: PodAWSNeuronCore, PodName: DummyPod, MemoryLocation: "None", RuntimeTag: "DEFAULT"}}, []float64{4, 5, 6}, pmetric.MetricTypeSum, Percent),
		"container_neuroncore_utilization": createExpectedMetric("container_neuroncore_utilization", false, []map[string]string{{NeuronCore: "core0", NeuronDevice: "device0", NeuronCoreTag: "0", Type: ContainerAWSNeuronCore, PodName: DummyPod, MemoryLocation: "None", RuntimeTag: "DEFAULT"}, {NeuronCore: "core1", NeuronDevice: "device0", NeuronCoreTag: "1", Type: ContainerAWSNeuronCore, PodName: DummyPod, MemoryLocation: "None", RuntimeTag: "DEFAULT"}, {NeuronCore: "core2", NeuronDevice: "device1", NeuronCoreTag: "2", Type: ContainerAWSNeuronCore, PodName: DummyPod, MemoryLocation: "None", RuntimeTag: "DEFAULT"}}, []float64{4, 5, 6}, pmetric.MetricTypeSum, Percent),
	}
