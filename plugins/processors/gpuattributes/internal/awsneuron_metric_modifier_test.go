...
func TestMetricModifierForExecutionErrorMetric(t *testing.T) {
	...
	expectedMetrics := map[string]pmetric.Metric{
		...
		"node_neuron_execution_errors_generic":   createExpectedMetric("node_neuron_execution_errors_generic", true, []map[string]string{{Type: NodeAWSNeuron, RuntimeTag: "1", ErrorType: "generic"}}, []float64{1}, pmetric.MetricTypeSum, Count),
		"node_neuron_execution_errors_numerical": createExpectedMetric("node_neuron_execution_errors_numerical", true, []map[string]string{{Type: NodeAWSNeuron, RuntimeTag: "1", ErrorType: "numerical"}}, []float64{2}, pmetric.MetricTypeSum, Count),
		"node_neuron_execution_errors_transient": createExpectedMetric("node_neuron_execution_errors_transient", true, []map[string]string{{Type: NodeAWSNeuron, RuntimeTag: "1", ErrorType: "transient"}}, []float64{3}, pmetric.MetricTypeSum, Count),
		"node_neuron_execution_errors_model":     createExpectedMetric("node_neuron_execution_errors_model", true, []map[string]string{{Type: NodeAWSNeuron, RuntimeTag: "1", ErrorType: "model"}}, []float64{4}, pmetric.MetricTypeSum, Count),
		"node_neuron_execution_errors_runtime":   createExpectedMetric("node_neuron_execution_errors_runtime", true, []map[string]string{{Type: NodeAWSNeuron, RuntimeTag: "1", ErrorType: "runtime"}}, []float64{5}, pmetric.MetricTypeSum, Count),
		"node_neuron_execution_errors_hardware":  createExpectedMetric("node_neuron_execution_errors_hardware", true, []map[string]string{{Type: NodeAWSNeuron, RuntimeTag: "1", ErrorType: "hardware"}}, []float64{6}, pmetric.MetricTypeSum, Count),
		"node_neuron_execution_errors_total":     createExpectedMetric("node_neuron_execution_errors_total", true, []map[string]string{{Type: NodeAWSNeuron, RuntimeTag: "1", ErrorType: "generic"}}, []float64{21}, pmetric.MetricTypeSum, Count),
	}
...
func TestMetricModifierForExecutionStatusMetric(t *testing.T) {
	...
	expectedMetrics := map[string]pmetric.Metric{
		...
		"node_neuron_execution_status_completed":              createExpectedMetric("node_neuron_execution_status_completed", true, []map[string]string{{Type: NodeAWSNeuron, RuntimeTag: "1", StatusType: "completed"}}, []float64{1}, pmetric.MetricTypeSum, Count),
		"node_neuron_execution_status_completed_with_err":     createExpectedMetric("node_neuron_execution_status_completed_with_err", true, []map[string]string{{Type: NodeAWSNeuron, RuntimeTag: "1", StatusType: "completed_with_err"}}, []float64{2}, pmetric.MetricTypeSum, Count),
		"node_neuron_execution_status_completed_with_num_err": createExpectedMetric("node_neuron_execution_status_completed_with_num_err", true, []map[string]string{{Type: NodeAWSNeuron, RuntimeTag: "1", StatusType: "completed_with_num_err"}}, []float64{3}, pmetric.MetricTypeSum, Count),
		"node_neuron_execution_status_timed_out":              createExpectedMetric("node_neuron_execution_status_timed_out", true, []map[string]string{{Type: NodeAWSNeuron, RuntimeTag: "1", StatusType: "timed_out"}}, []float64{4}, pmetric.MetricTypeSum, Count),
		"node_neuron_execution_status_incorrect_input":        createExpectedMetric("node_neuron_execution_status_incorrect_input", true, []map[string]string{{Type: NodeAWSNeuron, RuntimeTag: "1", StatusType: "incorrect_input"}}, []float64{5}, pmetric.MetricTypeSum, Count),
		"node_neuron_execution_status_failed_to_queue":        createExpectedMetric("node_neuron_execution_status_failed_to_queue", true, []map[string]string{{Type: NodeAWSNeuron, RuntimeTag: "1", StatusType: "failed_to_queue"}}, []float64{6}, pmetric.MetricTypeSum, Count),
	}
...
func TestMetricModifierForNeuronDeviceEccEventMetric(t *testing.T) {
	...
	expectedMetrics := map[string]pmetric.Metric{
		...
		"node_neurondevice_hw_ecc_events_mem_ecc_corrected":         createExpectedMetric("node_neurondevice_hw_ecc_events_mem_ecc_corrected", false, []map[string]string{{NeuronDevice: "device1", PodName: DummyPod, Type: NodeAWSNeuronDevice, RuntimeTag: "1", EventType: "mem_ecc_corrected", NeuronDeviceIndex: "1"}}, []float64{1}, pmetric.MetricTypeSum, Count),
		"node_neurondevice_hw_ecc_events_mem_ecc_uncorrected":       createExpectedMetric("node_neurondevice_hw_ecc_events_mem_ecc_uncorrected", false, []map[string]string{{NeuronDevice: "device1", PodName: DummyPod, Type: NodeAWSNeuronDevice, RuntimeTag: "1", EventType: "mem_ecc_uncorrected", NeuronDeviceIndex: "1"}}, []float64{2}, pmetric.MetricTypeSum, Count),
		"node_neurondevice_hw_ecc_events_sram_ecc_corrected":        createExpectedMetric("node_neurondevice_hw_ecc_events_sram_ecc_corrected", false, []map[string]string{{NeuronDevice: "device1", PodName: DummyPod, Type: NodeAWSNeuronDevice, RuntimeTag: "1", EventType: "sram_ecc_corrected", NeuronDeviceIndex: "1"}}, []float64{3}, pmetric.MetricTypeSum, Count),
		"node_neurondevice_hw_ecc_events_sram_ecc_uncorrected":      createExpectedMetric("node_neurondevice_hw_ecc_events_sram_ecc_uncorrected", false, []map[string]string{{NeuronDevice: "device1", PodName: DummyPod, Type: NodeAWSNeuronDevice, RuntimeTag: "1", EventType: "sram_ecc_uncorrected", NeuronDeviceIndex: "1"}}, []float64{4}, pmetric.MetricTypeSum, Count),
		"node_neurondevice_hw_ecc_events_total":                     createExpectedMetric("node_neurondevice_hw_ecc_events_total", false, []map[string]string{{NeuronDevice: "device1", PodName: DummyPod, Type: NodeAWSNeuronDevice, RuntimeTag: "1", EventType: "mem_ecc_corrected", NeuronDeviceIndex: "1"}}, []float64{10}, pmetric.MetricTypeSum, Count),
		...
		"pod_neurondevice_hw_ecc_events_total":                      createExpectedMetric("pod_neurondevice_hw_ecc_events_total", false, []map[string]string{{NeuronDevice: "device1", PodName: DummyPod, Type: PodAWSNeuronDevice, RuntimeTag: "1", EventType: "mem_ecc_corrected", NeuronDeviceIndex: "1"}}, []float64{10}, pmetric.MetricTypeSum, Count),
		...
		"container_neurondevice_hw_ecc_events_total":                createExpectedMetric("container_neurondevice_hw_ecc_events_total", false, []map[string]string{{NeuronDevice: "device1", PodName: DummyPod, Type: ContainerAWSNeuronDevice, RuntimeTag: "1", EventType: "mem_ecc_corrected", NeuronDeviceIndex: "1"}}, []float64{10}, pmetric.MetricTypeSum, Count),
	}
...
func TestMetricModifierForNeuronDeviceEccEventMetric_PodNameMissing(t *testing.T) {
	...
	expectedMetrics := map[string]pmetric.Metric{
		NeuronDeviceHwEccEvents:                                metricsList.At(0),
		"node_neurondevice_hw_ecc_events_mem_ecc_corrected":    createExpectedMetric("node_neurondevice_hw_ecc_events_mem_ecc_corrected", false, []map[string]string{{NeuronDevice: "device1", Type: NodeAWSNeuronDevice, RuntimeTag: "1", EventType: "mem_ecc_corrected", NeuronDeviceIndex: "1"}}, []float64{1}, pmetric.MetricTypeSum, Count),
		"node_neurondevice_hw_ecc_events_mem_ecc_uncorrected":  createExpectedMetric("node_neurondevice_hw_ecc_events_mem_ecc_uncorrected", false, []map[string]string{{NeuronDevice: "device1", Type: NodeAWSNeuronDevice, RuntimeTag: "1", EventType: "mem_ecc_uncorrected", NeuronDeviceIndex: "1"}}, []float64{2}, pmetric.MetricTypeSum, Count),
		"node_neurondevice_hw_ecc_events_sram_ecc_corrected":   createExpectedMetric("node_neurondevice_hw_ecc_events_sram_ecc_corrected", false, []map[string]string{{NeuronDevice: "device1", Type: NodeAWSNeuronDevice, RuntimeTag: "1", EventType: "sram_ecc_corrected", NeuronDeviceIndex: "1"}}, []float64{3}, pmetric.MetricTypeSum, Count),
		"node_neurondevice_hw_ecc_events_sram_ecc_uncorrected": createExpectedMetric("node_neurondevice_hw_ecc_events_sram_ecc_uncorrected", false, []map[string]string{{NeuronDevice: "device1", Type: NodeAWSNeuronDevice, RuntimeTag: "1", EventType: "sram_ecc_uncorrected", NeuronDeviceIndex: "1"}}, []float64{4}, pmetric.MetricTypeSum, Count),
		"node_neurondevice_hw_ecc_events_total":                createExpectedMetric("node_neurondevice_hw_ecc_events_total", false, []map[string]string{{NeuronDevice: "device1", Type: NodeAWSNeuronDevice, RuntimeTag: "1", EventType: "mem_ecc_corrected", NeuronDeviceIndex: "1"}}, []float64{10}, pmetric.MetricTypeSum, Count),
	}
