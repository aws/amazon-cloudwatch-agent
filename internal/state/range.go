...
// newRangeTracker creates a RangeTracker based on the capacity. If the capacity is <= 1, it creates a
// singleRangeTracker. Otherwise, it will create a multiRangeTracker configured with the capacity.
