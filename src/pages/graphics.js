          ...
          <div class="graph_content">
            <div class="header">
              ...
              <p>
                ...
                If a statistic is off it will be show with a {<BsSuitDiamondFill />}(OFF)
          ...
          <div class="graph_settings">
            <div class="settings_page">
              ...
              <div class="setting_box">
                ...
                <Setting title="Graph Font Size" settingKey="graphFontSize" type="select" range={[8, 32, 4, 'px']} page={this} />
                <Setting title="Graph Size" settingKey="graphSize" type="select" range={[1, 6, 1, '']} page={this} />
                <Setting title="Number of Last Commits" settingKey="nLastCommits" type="select" range={[10, 50, 5, ' commits']} page={this} />
