...
import { Code, Equalizer, Home, TrendingUp } from '@mui/icons-material';
...
export function AppToolbar(): JSX.Element {
    return (
        ...
        >
            ...
            >
                {/* App name / logo */}
                <Link href="/amazon-cloudwatch-agent/#" sx={{ padding: '8px 16px 3px' }}>
                    <CloudWatchIcon />
                </Link>
                <Box sx={{ display: 'flex', alignItems: 'center', gap: '25px' }}>
                    <Link href="/amazon-cloudwatch-agent/#" sx={{ display: 'flex', gap: '10px', color: '#FFF' }}>
                        <Home sx={{ color: '#FFF' }} />
                        <Typography>Home</Typography>
                    </Link>

                    <Link href="/amazon-cloudwatch-agent/#/report" sx={{ display: 'flex', gap: '10px', color: '#FFF' }}>
                        <Equalizer sx={{ color: '#FFF' }} />
                        <Typography>Performance Report</Typography>
                    </Link>
                    <Link href="/amazon-cloudwatch-agent/#/trend" sx={{ display: 'flex', gap: '10px', color: '#FFF' }}>
