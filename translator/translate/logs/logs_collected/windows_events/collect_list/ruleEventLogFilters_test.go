...
func TestApplyEventLogFiltersRuleEdgeCaseRegex(t *testing.T) {
	...
	// Test should verify behavior with anchors, escapes, wildcards, and empty expressions
}
...
func TestApplyEventLogFiltersRuleInvalidRegexPatterns(t *testing.T) {
	...
	for _, testCase := range testCases {
		...
		assert.Greater(t, len(translator.ErrorMessages), 0, "Expected error message for invalid regex")
	}
}
