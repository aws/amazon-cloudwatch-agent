		...
		metricDeclarations = []*awsemfexporter.MetricDeclaration{
			{
				...
				MetricNameSelectors: []string{
					containerinsightscommon.MetricName(containerinsightscommon.TypeNode, containerinsightscommon.NvmeReadOpsTotal),
					containerinsightscommon.MetricName(containerinsightscommon.TypeNode, containerinsightscommon.NvmeWriteOpsTotal),
					containerinsightscommon.MetricName(containerinsightscommon.TypeNode, containerinsightscommon.NvmeReadBytesTotal),
					containerinsightscommon.MetricName(containerinsightscommon.TypeNode, containerinsightscommon.NvmeWriteBytesTotal),
					containerinsightscommon.MetricName(containerinsightscommon.TypeNode, containerinsightscommon.NvmeReadTime),
					containerinsightscommon.MetricName(containerinsightscommon.TypeNode, containerinsightscommon.NvmeWriteTime),
					containerinsightscommon.MetricName(containerinsightscommon.TypeNode, containerinsightscommon.NvmeExceededIOPSTime),
					containerinsightscommon.MetricName(containerinsightscommon.TypeNode, containerinsightscommon.NvmeExceededTPTime),
					containerinsightscommon.MetricName(containerinsightscommon.TypeNode, containerinsightscommon.NvmeExceededEC2IOPSTime),
					containerinsightscommon.MetricName(containerinsightscommon.TypeNode, containerinsightscommon.NvmeExceededEC2TPTime),
					containerinsightscommon.MetricName(containerinsightscommon.TypeNode, containerinsightscommon.NvmeVolumeQueueLength),
				},
			},
		}
	}
		...
		metricDeclarations = []*awsemfexporter.MetricDeclaration{
			{
				...
				MetricNameSelectors: []string{
					containerinsightscommon.MetricName(containerinsightscommon.TypeNode, containerinsightscommon.NvmeInstanceStoreReadOpsTotal),
					containerinsightscommon.MetricName(containerinsightscommon.TypeNode, containerinsightscommon.NvmeInstanceStoreWriteOpsTotal),
					containerinsightscommon.MetricName(containerinsightscommon.TypeNode, containerinsightscommon.NvmeInstanceStoreReadBytesTotal),
					containerinsightscommon.MetricName(containerinsightscommon.TypeNode, containerinsightscommon.NvmeInstanceStoreWriteBytesTotal),
					containerinsightscommon.MetricName(containerinsightscommon.TypeNode, containerinsightscommon.NvmeInstanceStoreReadTime),
					containerinsightscommon.MetricName(containerinsightscommon.TypeNode, containerinsightscommon.NvmeInstanceStoreWriteTime),
					containerinsightscommon.MetricName(containerinsightscommon.TypeNode, containerinsightscommon.NvmeInstanceStoreExceededEC2IOPSTime),
					containerinsightscommon.MetricName(containerinsightscommon.TypeNode, containerinsightscommon.NvmeInstanceStoreExceededEC2TPTime),
					containerinsightscommon.MetricName(containerinsightscommon.TypeNode, containerinsightscommon.NvmeInstanceStoreVolumeQueueLength),
				},
			},
		}
	}
