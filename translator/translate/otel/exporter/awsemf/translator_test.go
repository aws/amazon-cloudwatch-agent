		...
		"GenerateAwsEmfExporterConfigKubernetesWithEnableFullPodAndContainerMetrics": {
			...
			want: map[string]any{
				...
				"metric_declarations": []*awsemfexporter.MetricDeclaration{
					...
					{
						Dimensions: [][]string{{"ClusterName"}, {"ClusterName", "Namespace", "PodName", "ContainerName"}, {"ClusterName", "Namespace", "PodName", "FullPodName", "ContainerName"}, {"ClusterName", "Namespace", "PodName", "FullPodName", "ContainerName", "ElasticNetworkInterfaceId"}},
						MetricNameSelectors: []string{
					...
					{
						Dimensions: [][]string{{"ClusterName"}, {"ClusterName", "Namespace"}, {"ClusterName", "Namespace", "Service"}, {"ClusterName", "Namespace", "PodName"}, {"ClusterName", "Namespace", "PodName", "FullPodName"},  {"ClusterName", "Namespace", "PodName", "FullPodName", "ElasticNetworkInterfaceId"}},
						MetricNameSelectors: []string{
					...
					{
						Dimensions: [][]string{{"ClusterName"}, {"ClusterName", "NodeName", "InstanceId"}, {"ClusterName", "NodeName", "InstanceId", "ElasticNetworkInterfaceId"}},
						MetricNameSelectors: []string{
