		...
		"GenerateAwsEmfExporterConfigKubernetesWithEnableFullPodAndContainerMetrics": {
			...
			want: map[string]any{
				...
				"metric_declarations": []*awsemfexporter.MetricDeclaration{
					...
					{
						Dimensions: [][]string{{"ClusterName"}, {"ClusterName", "Namespace", "Service"}, {"ClusterName", "Namespace", "PodName"}, {"ClusterName", "Namespace", "PodName", "FullPodName"}},
						MetricNameSelectors: []string{
					...
					},
					{
						...
						MetricNameSelectors: []string{
							"node_gpu_limit", "node_gpu_usage_total", "node_gpu_reserved_capacity",
						},
					},
					{
