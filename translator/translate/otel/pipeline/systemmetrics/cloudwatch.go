...
func newCloudWatchTranslator(imdsAvailable bool) common.ComponentTranslator {
	return &cloudWatchTranslator{factory: cloudwatch.NewFactory(), imdsAvailable: imdsAvailable}
}
