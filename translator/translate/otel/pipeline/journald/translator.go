...
// Translate creates a pipeline for journald logs.
func (t *translator) Translate(conf *confmap.Conf) (*common.ComponentTranslators, error) {
	if conf == nil || !conf.IsSet(common.JournaldConfigKey) {
		return nil, &common.MissingKeyError{ID: t.ID(), JsonKey: common.JournaldConfigKey}
	}
