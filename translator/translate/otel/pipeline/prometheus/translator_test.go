	...
	testCases := map[string]struct {
		...
		"WithMetricsWithCloudWatchDestination": {
			...
			want: &want{
				...
				receivers:  []string{"prometheus/prometheus/cloudwatchlogs"},
		...
		"WithValidAMP": {
			...
			want: &want{
				...
				processors: []string{"prometheusadapter/prometheus/amp", "batch/prometheus/amp", "deltatocumulative/prometheus/amp"},
