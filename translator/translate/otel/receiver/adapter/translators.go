...
var (
	...
	skipInputSet     = collections.NewSet[string](files.SectionKey, windowsevents.SectionKey, common.AppSignals, common.AppSignalsFallback, common.JournaldKey, common.SyslogKey)
