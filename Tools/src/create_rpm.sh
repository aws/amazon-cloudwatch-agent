...
cp ${PREPKGPATH}/workload-discovery ${BUILD_ROOT}/SOURCES/opt/aws/amazon-cloudwatch-agent/bin/
...
chmod 700 ${BUILD_ROOT}/SOURCES/opt/aws/amazon-cloudwatch-agent/bin/workload-discovery
